...
class CreateAdminAccountScreen extends Component {
...
onChange = (e) =>
    ...
    registerUser = (e) => {
      e.preventDefault();
      let user1 = {firstName: this.state.firstName, lastName: this.state.lastName, email: this.state.email, password: this.state.password, phone: this.state.phone, role:this.state.role};
      ApiCustomerService.addAdmin(user1)
          .then(res => {
