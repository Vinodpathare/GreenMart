...
import CreateAdminAccountScreen from './screens/customer/CreateAdminAccountScreen';
...
import PaymentScreen1 from './screens/customer/PaymentScreen1';
    ...
    <Router>
      <div>
        <Switch>
          ...
          <Route path="/create-adminaccount" component={CreateAdminAccountScreen}/>
          ...
          <Route path="/razorpay" component={PaymentScreen1}/>
