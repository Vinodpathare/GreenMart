...
class ApiCustomerService {
    ...
    checkUser(body){
        return axios.post(USER_API_BASE_URL + '/check/', body);
    }
    addUser(user) {
        return axios.post(USER_API_BASE_URL + '/signup/', user);
    }
    addAdmin(user1) {
        return axios.post(USER_API_BASE_URL + '/signup/', user1);
    }
    ...
    // } 
    addpaymentDetails1(paymentdata) {
        return axios.post(USER_API_BASE_URL+'/paymentadd/',paymentdata);
    }
    addpaymentDetails(userId) {
        return axios.get(USER_API_BASE_URL+'/payment/'+ userId);
    }  
